...
8. **Hygiene scan**: Before pushing, scan the full fork diff (`git diff upstream/main..HEAD`) for sensitive content:
   ...
   Known items to watch for: `CLAUDE.md` line 10 (`personal:tributech/...`), `docs/` directory (internal Rails backend paths). If any unexpected sensitive content is found, warn the user and do NOT push until confirmed.
9. Ask user to confirm before pushing.
10. Push and retag:
   ```
