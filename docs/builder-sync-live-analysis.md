...
Date: 2026-02-16  
Scope: `old-world-builder` fork + Rails backend integration in `[devfolder]/oldworldrankings`
...
- Web: `[devfolder]/oldworldrankings/app/controllers/api/builder_sync_controller.rb:31`
- Mobile: `[devfolder]/oldworldrankings/app/api/owr/v1/builder_sync.rb:32`
...
- `[devfolder]/oldworldrankings/app/controllers/application_controller.rb:91`
...
- Server merge keeps server on equal timestamps (`>` for client win only):
  - `[devfolder]/oldworldrankings/app/services/builder_sync_service.rb:51`
...
- Service:
  - `[devfolder]/oldworldrankings/app/services/builder_sync_service.rb:21`
  - `[devfolder]/oldworldrankings/app/services/builder_sync_service.rb:67`
- Specs:
  - `[devfolder]/oldworldrankings/spec/requests/api/v1/builder_sync_spec.rb:208`
